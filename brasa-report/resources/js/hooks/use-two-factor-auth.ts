...
export const useTwoFactorAuth = (): UseTwoFactorAuthReturn => {
    ...
    const fetchQrCode = useCallback(async (): Promise<void> => {
        try {
            ...
            setErrors((prev) => [...prev, 'Não foi possível obter o QR Code']);
            setQrCodeSvg(null);
        }
    }, []);
    ...
    const fetchSetupKey = useCallback(async (): Promise<void> => {
        try {
            ...
            setErrors((prev) => [...prev, 'Não foi possível obter a chave de configuração']);
    ...
    const fetchRecoveryCodes = useCallback(async (): Promise<void> => {
        try {
            ...
            setErrors((prev) => [...prev, 'Não foi possível obter os códigos de recuperação']);
