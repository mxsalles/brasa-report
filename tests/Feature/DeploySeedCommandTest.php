...
test('deploy:seed aplica o DatabaseSeeder e finaliza com sucesso', function () {
...
test('deploy:seed não aplica sementes quando SEED_ON_DEPLOY está falso', function () {
