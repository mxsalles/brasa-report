    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Os códigos de recuperação permitem acessar sua conta se você
                    perder o dispositivo com 2FA. Guarde-os em um gerenciador de
                    senhas seguro.
                </CardDescription>
            </CardHeader>
            <CardContent>
                            ...
                            <>
                                ...
                                <div className="text-xs text-muted-foreground select-none">
                                    <p id="regenerate-warning">
                                        ...
                                        uso. Se precisar de novos, clique em{' '}
